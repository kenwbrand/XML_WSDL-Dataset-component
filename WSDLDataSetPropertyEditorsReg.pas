...
uses SysUtils, Forms, Dialogs, Controls, WSDLClientDataSet, WSDLIntf, Messages;
...
begin
  inherited;
  Methods := TWSDLClientDataSet(GetComponent(0)).SoapHelper.GetMethods(False);
...
begin
  ...
  for Cnt := 0 to TWSDLClientDataSet(GetComponent(0)).SoapHelper.OverLoadCount - 1 do
    Proc(IntToStr(Cnt + 1));
end;
